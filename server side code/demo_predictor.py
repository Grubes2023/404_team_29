...
test_input_list_2 = ['Boyd', 'I just got freakin fired from my job. In search of a new one. Help', '2023']
...
def make_prediction(my_input):
    ...
    if isinstance(my_input[0], list):
            my_prediction = make_batch_pred(my_input, model_v='0.8_charlie')
...
# testing if it can handle both cases
print('')
